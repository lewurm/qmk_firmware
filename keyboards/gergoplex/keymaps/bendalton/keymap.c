...
// 		RESET, KC_TAB, KC_LGUI, KC_LSFT, KC_ENT,KC_LCTL, KC_LALT, KC_SPC, KC_NO, KC_MINS, KC_QUOT, KC_ENT),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,               KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,
    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,               KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN,
    CMD_Z,  CTRL_X,   ALT_C,   GUI_V,   NUM_B,              NUM_N,   GUI_M,  ALT_COMM, CTRL_DOT, KC_SLSH,
    _NUM,  _SFT_DEL,_TD_ENTGUI,                   _SPCNAV, _SFT_BSPC, SYM_OS
    ),

    [_COLEMAK] = LAYOUT_gergoplex(
    KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,               KC_J,    KC_L,    KC_U,    KC_Y,   _TD_CLN,
    KC_A,    KC_R,    KC_S,    KC_T,    KC_D,               KC_H,    KC_N,    KC_E,    KC_I,    KC_O,
    CMD_Z,   CTRL_X,   ALT_C,   GUI_V,   NUM_B,               NUM_K,    GUI_M,  ALT_COMM, CTRL_DOT, KC_SLSH,
    _NUM,  _SFT_DEL,_TD_ENTGUI,                   _SPCNAV, _SFT_BSPC, SYM_OS
     ),

    [_NAV] = LAYOUT_gergoplex(
    ____, ____,  ____, ____,  ____,               KC_END, KC_PGDN, KC_PGUP, KC_HOME, ____,
    ____, ____, KC_MUTE, KC_VOLU,  ____,               KC_LEFT, KC_DOWN,  KC_UP,  KC_RGHT,  ____,
    KC_LALT, KC_LCTL, KC_LGUI, KC_VOLD, ____,              _PREV_TAB,_LINE_DOWN,_LINE_UP,_NEXT_TAB,   ____,
    _______,  _______, _______,  _______,  _______, _______
  ),
    [_SYMBOLS] = LAYOUT_gergoplex(
   ____,    ____,    ____,    ____,   ____,                       LSFT(KC_BSLASH),  KC_GRV,  KC_LCBR, KC_RCBR, LSFT(KC_MINUS),
    ____,    ____,    ____,   ____, ____,                               KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_MINUS,
       KC_LCTRL, KC_LALT, KC_LGUI,  ____,   ____,    KC_PLUS,  KC_EQL,  KC_LT,   KC_GT,  KC_BSLASH,
      _______,  _______, _______,  _______,  _______, _______
    ),
    [_COMMAND] = LAYOUT_gergoplex(
  RESET, _WINMODE, ____, TO(_COLEMAK),TO(_QWERTY),                       HYPR(KC_Y),HYPR(KC_U),HYPR(KC_I),HYPR(KC_O),    HYPR(KC_B),
   ____,   DEBUG,    ____,    ____, ____,                              HYPR(KC_H),HYPR(KC_J),HYPR(KC_K),HYPR(KC_L),    HYPR(KC_X),
      ____,   LCTL(KC_LEFT),LCTL(KC_DOWN),LCTL(KC_UP),LCTL(KC_RIGHT),   HYPR(KC_N),HYPR(KC_M),HYPR(KC_T),HYPR(KC_G),  HYPR(KC_G),
    _______,  _______, _______,  _______,  _______, _______
    ),
    [_NUMBERS] = LAYOUT_gergoplex(
   LSFT(KC_1),LSFT(KC_2),LSFT(KC_3),LSFT(KC_4),LSFT(KC_5),                  LSFT(KC_6),LSFT(KC_7),LSFT(KC_8),LSFT(KC_9),LSFT(KC_0),
       KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                                KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
    ____,    ____,    ____,    ____,  ____,   KC_PLUS, KC_EQL,  KC_COMM,  KC_DOT,  KC_SLSH,
      _______,  _______, _______,  _______,  _______, _______
    )
};
